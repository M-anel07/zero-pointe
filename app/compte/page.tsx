            ...
            <header className="border-b border-white/15 py-5 sticky top-0 z-10 bg-[#080808]/95 backdrop-blur-md w-full">
                <div className="w-full px-8 flex items-center justify-between">
                    ...
                    <div className="hidden sm:flex flex-col items-end gap-1">
                        <span className="text-[10px] uppercase tracking-[2.5px] text-zinc-300 font-bold">total craqué</span>
                        ...
                        <span className="text-[10px] text-zinc-400 font-medium">sur 12 mois</span>
                    </div>
                </div>
            </header>
            ...
            <main className="flex-1 w-full px-8 py-10 flex flex-col gap-8">
                ...
                <div className="relative flex items-center gap-8 p-8 rounded-2xl bg-[#0d0d0d] border border-white/15 overflow-hidden">
                    <div className="absolute inset-0 pointer-events-none"
                        style={{ backgroundImage: "radial-gradient(circle at 85% 50%, rgba(255,74,125,0.15) 0%, transparent 60%)" }}
                    />
                    ...
                    <div className="hidden sm:flex flex-col items-end shrink-0 gap-1">
                        <span className="text-[10px] uppercase tracking-[2px] text-zinc-400 font-bold">membre depuis</span>
                        <span className="text-base font-bold text-white">{dateInscription ?? "—"}</span>
                    </div>
                </div>
                    ...
                    <div className="flex flex-col gap-5">
                        <div className="bg-[#0d0d0d] border border-white/15 rounded-2xl overflow-hidden">
                            ...
                            <div className="px-6 py-5 flex items-center gap-4 border-b border-white/10 hover:bg-white/[0.04] transition-colors cursor-pointer">
                                ...
                                <div className="flex-1 min-w-0">
                                    <p className="text-[9px] uppercase tracking-[2px] text-zinc-400 font-bold">pseudo</p>
                                    <p className="text-sm text-white font-bold mt-0.5 truncate">{user?.pseudo || "—"}</p>
                                </div>
                            </div>
                            ...
                            <div className="px-6 py-5 flex items-center gap-4 border-b border-white/10 hover:bg-white/[0.04] transition-colors cursor-pointer">
                                ...
                                <div className="flex-1 min-w-0">
                                    <p className="text-[9px] uppercase tracking-[2px] text-zinc-400 font-bold">email</p>
                                    <p className="text-sm text-white font-bold mt-0.5 truncate">{user?.email}</p>
                                </div>
                            </div>
                            ...
                            <div className="px-6 py-5 flex items-center gap-4 hover:bg-white/[0.04] transition-colors cursor-pointer">
                                ...
                                <div className="flex-1 min-w-0">
                                    <p className="text-[9px] uppercase tracking-[2px] text-zinc-400 font-bold">mot de passe</p>
                                    <p className="text-sm text-zinc-400 tracking-widest mt-0.5 select-none font-bold">••••••••••</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="flex flex-col gap-5">
                        <div className="grid grid-cols-3 gap-3">
                            <div className="bg-[#0d0d0d] border border-white/15 rounded-2xl p-4 flex flex-col gap-1">
                                ...
                                <p className="text-[9px] uppercase tracking-[1.5px] text-zinc-300 font-extrabold leading-tight">affaires traitées</p>
                            </div>

                            <div className="bg-[#0d0d0d] border border-white/15 rounded-2xl p-4 flex flex-col gap-1">
                                <p className="text-2xl font-black text-white">{nbDepenses}</p>
                                <p className="text-[9px] uppercase tracking-[1.5px] text-zinc-300 font-extrabold leading-tight">dossiers soumis</p>
                            </div>
                        ...
                        <div className="bg-[#0d0d0d] border border-red-500/40 rounded-2xl overflow-hidden flex-1 shadow-lg shadow-red-950/20">
                            <div className="px-6 py-4 border-b border-red-500/20 flex items-center gap-2 bg-red-950/20">
                                ...
                                <p className="text-[11px] uppercase tracking-[2.5px] text-red-400 font-extrabold">zone dangereuse</p>
                            </div>
                            <div className="p-6 flex flex-col gap-5">
                                <div>
                                    <p className="text-base text-white font-bold">Supprimer mon compte</p>
                                    <p className="text-sm text-zinc-300 mt-2 leading-relaxed font-medium">
                                        Action irréversible — tous tes votes et dépenses seront définitivement effacés du serveur.
                                    </p>
                                </div>
                                <BoutonSuppression />
                            </div>
